...
exports.blockZoomerOrigins = void 0;
...
const blockZoomerOrigins = (req) => {
    ...
    if (origin && DISALLOWED_ORIGIN_SUBSTRINGS.some((s) => origin.includes(s))) {
        ...
        throw new ZoomerForbiddenError(`Your access was terminated due to violation of our policies, please check your email for more information. If you believe this is in error and would like to appeal, please contact us through our help center at help.openai.com.`);
    }
};
exports.blockZoomerOrigins = blockZoomerOrigins;
//# sourceMappingURL=block-zoomer-origins.js.map