...
exports.getCostSuffix = exports.prettyTokens = exports.getTokenCostUsd = void 0;
...
function getTokenCostUsd(model, tokens) {
    let cost = 0;
    switch (model) {
        case "gpt4o":
        case "azure-gpt4o":
...
exports.getTokenCostUsd = getTokenCostUsd;
...
function getCostSuffix(cost) {
    if (!config_1.config.showTokenCosts)
        return "";
    return ` ($${cost.toFixed(2)})`;
}
exports.getCostSuffix = getCostSuffix;
